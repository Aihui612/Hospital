...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = __webpack_require__(/*! ./request.js */ 18);
...
var indexApi = {
  ...
  */
  ...
  getHospitalList: function getHospitalList(params) {
    return (0, _request.request)({
      method: 'Get',
  ...
  /**
     ...
     */
  postApplySubInfo: function postApplySubInfo(params) {
    return (0, _request.request)({
      method: 'Post',
  ...
  getHospitalDetail: function getHospitalDetail(params) {
    return (0, _request.request)({
      method: 'Get',
      url: '/api/wu/hospital/',
      params: params });
...
var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                            * @description  axios 请求封装；
                                                                                                                                                            * 
                                                                                                                                                           */ // 请求头
var header = 'application/x-www-form-urlencoded';var headerPost = 'application/json'; // 对外接口
function request(_ref)

{var method = _ref.method,url = _ref.url,params = _ref.params,loading = _ref.loading;

  var url1 = _config.default.loadUrl + url;
  console.log('url1', _config.default.loadUrl, '  ', url);
...
/**
 * @description  配置后端接口请求地址；
 * 
*/

// swagger 地址  http://syc320.320.io/swagger-ui.html 
// http://linshi2.shunlukeji.com
// http://linshi2.shunlukeji.com/prod-api 
module.exports = {
  loadUrl: 'http://linshi2.shunlukeji.com/prod-api',
